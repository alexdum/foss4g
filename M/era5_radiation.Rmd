...
scatterPlot(tab, y = "era5_ghi", x = "bsrn_ghi", type = "KG", xlab = "BSRN GHI [W/m²]", ylab = "ERA5 GHI [W/m²]", linear = T, smooth = T)
```
...
```{r plot_trends, echo=TRUE, fig.cap=plot.trends, fig.height=6, fig.width=10}
library(raster, quietly = T, warn.conflicts = F)
